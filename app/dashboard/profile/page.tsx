  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="glass-card p-6 animate-fade-up opacity-0" style={{ animationDelay: "400ms", animationFillMode: "forwards" }}>
        ...
        <div className="space-y-3">
          {[
            { label: "AI Title Suggestions", desc: "Auto-generate event titles based on category", enabled: true },
            { label: "Smart Descriptions", desc: "AI-assisted event description generation", enabled: true },
            { label: "Attendance Predictions", desc: "Forecast attendee numbers using AI (Beta)", enabled: false },
          ].map(({ label, desc, enabled: def }) => {
            const [on, setOn] = useState(def);
            return (
              <div key={label} className="flex items-center justify-between px-4 py-3 rounded-xl" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid var(--border-subtle)" }}>
                <div>
