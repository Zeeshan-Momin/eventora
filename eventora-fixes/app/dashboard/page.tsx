  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard label="Total Attendees" value={stats.totalAttendees} icon={<Users className="h-5 w-5" />} color="from-violet-500 to-purple-700" delay={300} />
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="grid sm:grid-cols-1 gap-3">
            {insights.map((insight, i) => (
              <div
                key={i}
                className="rounded-2xl p-5 border flex gap-4 items-start animate-fade-up opacity-0 transition-all hover:scale-[1.01]"
                style={{
